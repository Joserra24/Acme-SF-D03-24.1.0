...
public class AdministratorBannerUpdateService extends AbstractService<Administrator, Banner> {
	...
	public void validate(final Banner object) {
		...
		if (!super.getBuffer().getErrors().hasErrors(periodStart) && !super.getBuffer().getErrors().hasErrors(periodFinish)) {
		...
		if (!super.getBuffer().getErrors().hasErrors("instationUpdateMoment")) {
