...
<acme:list>
	<acme:list-column code="administrator.risk.list.label.reference" path="reference" width="15%"/>
	...
	<acme:list-column code="administrator.risk.list.label.description" path="description" width="50%"/>
</acme:list>
