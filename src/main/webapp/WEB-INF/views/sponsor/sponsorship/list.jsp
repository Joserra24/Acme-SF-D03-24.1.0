...
<acme:list>
	...
	<acme:list-column code="sponsor.sponsorship.list.label.durationStart" path="durationStart" width="20%"/>
	<acme:list-column code="sponsor.sponsorship.list.label.durationEnd" path="durationEnd" width="20%"/>
	<acme:list-column code="sponsor.sponsorship.list.label.amount" path="amount" width="15%"/>
	<acme:list-column code="sponsor.sponsorship.list.label.projectType" path="projectType" width="10%"/>
</acme:list>
