...
<acme:form>
	...
	<acme:input-select code="sponsor.sponsorship.form.label.projectType" path="projectType" choices="${types}"/>
	...
	<jstl:choose> 
		<jstl:when test="${_command == 'show' && draftMode == false}">
			<acme:button code="sponsor.sponsorship.form.button.invoices" action=""/>			
		</jstl:when>
